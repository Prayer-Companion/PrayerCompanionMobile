...
import com.prayercompanion.shared.data.local.assets.mappers.toQuranChapters
...
import com.prayercompanion.shared.data.local.db.entities.MemorizedQuranChapterEntity
...
class QuranRepositoryImpl constructor(
    ...
    private val quranChapters = assets.quran.map { it.toQuranChapters() }
